 ...
 */ 
  ...
  * 
  */
public class DPM4App extends AbstractSimulation {
  DPM4 hd = new DPM4();
//PlotFrame pressureData = new PlotFrame("steps", "PA/NkT", "Pressure");
  ...
  /** GOAL
   * Collect raw eigenvalue data at regular intervals, append data to .dat files. Output data file with relevant data. 
   */
  public void doStep() {
	  if(k<6){
	  if(k==0 && i==0){
		  File dir1 = new File("data/phiN="+hd.phi+",q="+hd.sizeRatio+"_");
    ...
    else
    {
      ...
      System.out.println("failed trying to create the directory");
		  ...
		  for(int i=1; i<6; i++){
		  File dir2 = new File("data/phiN="+hd.phi+",q="+hd.sizeRatio+"_" +"/" + i);
    ...
    try{    
           FileWriter fw=new FileWriter("data/phiN="+hd.phi+",q="+hd.sizeRatio+"_" +"/" + i +"/"+"phiN="+hd.phi+",q="+hd.sizeRatio+"_eX.dat");      
          }catch(Exception e){System.out.println(e);}    
          System.out.println("Success..."); 
    try{    
           FileWriter fw=new FileWriter("data/phiN="+hd.phi+",q="+hd.sizeRatio+"_" +"/" + i +"/"+"phiN="+hd.phi+",q="+hd.sizeRatio+"_eY.dat");    
           //fw.write(String.valueOf(data[0]));    
           //fw.close();    
          }catch(Exception e){System.out.println(e);}    
          System.out.println("Success...");    
     ...
     //WRITE DATA
		 ...
		 String strFilePathX = "data/phiN="+hd.phi+",q="+hd.sizeRatio+"_" +"/" + k +"/"+"phiN="+hd.phi+",q="+hd.sizeRatio+"_eX.dat";
		 String strFilePathY = "data/phiN="+hd.phi+",q="+hd.sizeRatio+"_" +"/" + k +"/"+"phiN="+hd.phi+",q="+hd.sizeRatio+"_eY.dat";
		 System.out.println(strFilePathX); 
		 //String strFilePathX = "testout.txt";
		 //String strFilePathY = "testout.txt";
		 try{    
  ...
  public static void main(String[] args) { // set up animation control structure using this class
    SimulationControl control = SimulationControl.createApp(new DPM4App());
